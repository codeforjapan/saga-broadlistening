...
## AIインタビュー機能について
${SITE_NAME}には「AIインタビュー」機能があります。これは施策ごとに提供される機能で、ユーザーがAIインタビュアーと対話形式で施策に対する意見や知見を共有できる仕組みです。インタビュー結果は分析・レポート化され、施策議論に活用されます。
`;
...
- ユーザーが自分の意見を共有したい、施策に反映してほしいと表明した場合
