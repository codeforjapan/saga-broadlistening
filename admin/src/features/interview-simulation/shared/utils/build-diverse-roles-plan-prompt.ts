 ...
 *
 * 各スロットを独立に generatePersonaFromSubject で生成すると、似たような
...
以下の${subjectLabel}について、**多様な視点を引き出す ${slotsToPlan.length} 人の当事者**を選定してください。
...
- この${subjectLabel}に関わりが深そうな当事者（影響を受ける側 / 運用する側 / 周辺で間接的に関わる側 等）から多面的に選ぶ
