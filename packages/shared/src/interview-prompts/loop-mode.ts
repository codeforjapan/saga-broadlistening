...
- **フォローアップ指針は、回答を得た後のフォローアップの指針です。** 最初の質問に混ぜず、ユーザーの回答を受けてから活用してください。指針に聞き出す観点が複数並んでいても、1ターンに聞くのはそのうち1つだけです。
...
- **1つのことだけ聞いているか**: 「AやB」「AとB」「Aや、そのときのB」のように、2つのことを並べて一度に聞かない
- **自然な日本語か**: 「感覚を教えてください」「感情を教えてください」のように気持ちを名詞で聞かず、「どう感じましたか？」「どんな気持ちでしたか？」と普段の話し言葉で聞く
