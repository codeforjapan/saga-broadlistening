...
9. **無関係な内容**: 施策や施策テーマと全く関係のない内容（明らかな脱線、私的なやり取り）
...
## 重要な注意
- 施策への賛成・反対の意見表明自体は、どれだけ強い表現であっても「適切」と判定してください
- 施策批判や行政への改善要望は、個人攻撃でない限り「適切」です
- 感情的な表現があっても、それが施策への真摯な意見であれば低スコア（適切寄り）にしてください
